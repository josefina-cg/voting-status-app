...
# ---- MAIN TITLE + SUBTITLE ----
st.markdown("""
    <h2 style='text-align: center; font-size: 36px;'>Propuesta Final en la Dirección del Trabajo</h2>
...
refresh_col, info_col = st.columns([2, 3])  # El botón ahora más largo, el mensaje más corto
